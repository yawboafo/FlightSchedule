...
private extension Selector {
    static let buttonTapped = #selector(DatePickerDialog.buttonTapped)
	 static let CancellTapped = #selector(DatePickerDialog.cancellTapped)
...
open class DatePickerDialog: UIView {
    public typealias DatePickerCallback = ( Date? ) -> Void
	  public typealias CancellCallback = () -> Void
    ...
    private var cancelCallback: CancellCallback?
    ...
    open func show(
        ...
        datePickerMode: UIDatePicker.Mode = .dateAndTime,
		  ...
		  cancellCallBack: @escaping CancellCallback
         ) {
      ...
      let schene = UIApplication.shared.connectedScenes.first as? UIWindowScene
		guard let window = schene?.windows.first else { return  }
    ...
    private func addButtonsToView(container: UIView) {
        ...
        if showCancelButton {
            ...
            self.cancelButton.addTarget(self, action: .CancellTapped, for: .touchUpInside)
